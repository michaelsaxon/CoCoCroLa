# forked from pipeline_stable_diffusion in diffusers
...
class StableDiffusionPipelineMidwayPatch(StableDiffusionPipeline):
    @torch.no_grad()
    def __call__(
        self,
        prompt: Union[str, List[str]] = None,
        second_prompt : Optional[Union[str, List[str]]] = None,
        ...
        second_prompt_embeds: Optional[torch.FloatTensor] = None,
...
# changes_list is a list of tuples (prompt, change_step)
# example configurations:
# changes_list = [("prompt2", 950), ("prompt3", 500), ("prompt4", 100)] will cycle through those (startying from "prompt" in other flag)
# changes_list = ("prompt2", 950) will swap to prompt2 at step 950 alone
# changes_list = (,950) will reset the seed at step 950
class StableDiffusionPipelineSwapPromptSteps(StableDiffusionPipeline):
    @torch.no_grad()
    def __call__(
        self,
        prompt: Union[str, List[str]] = None,
        changes_list : Optional[Union[Tuple[Optional[str], int], List[Tuple[Optional[str],int]]]] = None,
        height: Optional[int] = None,
        width: Optional[int] = None,
        num_inference_steps: int = 50,
        guidance_scale: float = 7.5,
